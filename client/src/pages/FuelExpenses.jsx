  ...
  return (
    <div className="w-full space-y-6 fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        >
          <p className="text-text-secondary text-sm font-medium">Total Spent (This Month)</p>
          <h3 className="text-3xl font-bold text-text-primary mt-2">$15,300</h3>
        ...
        <motion.div 
          ...
          className="lg:col-span-2 bg-[var(--color-bg-card)] p-6 rounded-xl border border-border h-64 shadow-sm hover-scale transition-all duration-300"
        >
      ...
      <div className="bg-[var(--color-bg-card)] rounded-xl border border-border overflow-hidden shadow-sm hover-scale transition-all duration-300">
        <div className="p-4 border-b border-border flex justify-between items-center bg-[var(--color-bg-card)]">
          <h2 className="text-xl font-semibold text-text-primary">Recent Fuel Logs</h2>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-[var(--color-bg-base)]/50">
                ...
                <th className="p-4 font-semibold text-text-secondary border-b border-border">Driver</th>
                <th className="p-4 font-semibold text-text-secondary border-b border-border">Gallons</th>
                <th className="p-4 font-semibold text-text-secondary border-b border-border">Cost</th>
                <th className="p-4 font-semibold text-text-secondary border-b border-border">Location</th>
              </tr>
            </thead>
            <tbody>
              {mockLogs.map((log, idx) => (
                ...
                >
                  ...
                  <td className="p-4 font-medium text-text-primary">{log.vehicle}</td>
                  ...
                  <td className="p-4 text-text-secondary">{log.location}</td>
                </motion.tr>
              ))}
            </tbody>
          </table>
